...
public class JwtRealm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken token) throws AuthenticationException {
        ...
        try {
            ...
            //验证host
            json = JSONObject.parseObject(claims.getSubject());
            ...
            throw new AuthenticationException("令牌过期:" + e.getMessage(),e);
        } catch (UnsupportedJwtException e) {
            throw new AuthenticationException("令牌无效:" + e.getMessage(),e);
        } catch (MalformedJwtException e) {
            throw new AuthenticationException("令牌格式错误:" + e.getMessage(),e);
        } catch (SignatureException e) {
            throw new AuthenticationException("令牌签名无效:" + e.getMessage(),e);
        } catch (IllegalArgumentException e) {
            throw new AuthenticationException("令牌参数异常:" + e.getMessage(),e);
        } catch (Exception e) {
            throw new AuthenticationException("令牌错误:" + e.getMessage(),e);
        }
    }
